...
<head>
    ...
    <style>
        /* ===== CSS VARIABLES (Black, White, Gold, Light Blue) ===== */
        :root {
            --primary: #D4AF37;
            /* Emas (Gold) */
            ...
            --primary-pale: #F4F9FC;
            /* Biru Muda sangat pudar untuk hover/bg */
            --primary-dark: #101216;
            /* Hitam pekat (Black) */
            --text-dark: #121212;
            /* Hitam teks */
        ...
        * {
        ...
        .navbar {
            background: #101216;
            /* Gelap menyesuaikan background logo */
        ...
        .btn-primary {
            background: linear-gradient(135deg, var(--primary) 0%, #E8C34B 100%);
            /* Emas gradient */
            border: none;
            color: var(--primary-dark);
            font-weight: 700;
        ...
        .btn-primary:hover {
            background: linear-gradient(135deg, #E8C34B 0%, #F5D365 100%);
            color: var(--primary-dark);
        ...
        /* -- CUSTOMER: Teal segar, ramah -- */
        .swal-customer.swal2-popup {
            border-top: 4px solid #4A90A4 !important;
            border-radius: 16px !important;
            font-family: 'Inter', sans-serif !important;
            box-shadow: 0 12px 40px rgba(74, 144, 164, .25) !important;
        }

        .swal-customer .swal2-title {
            color: #1A4F5E !important;
            font-weight: 700 !important;
        }

        .swal-customer .swal2-content,
        .swal-customer .swal2-html-container {
            color: #2C5F6E !important;
        }

        .swal-customer .swal2-timer-progress-bar {
            background: #4A90A4 !important;
        }

        .swal-customer .swal2-footer {
            border-top-color: #D0EEF5 !important;
            color: #78909C !important;
        }

        /* Toast Customer */
        .swal-customer.swal2-toast {
        ...
        /* -- ADMIN: Biru gelap, profesional -- */
        .swal-admin.swal2-popup {
            border-top: 4px solid #1565C0 !important;
            border-radius: 10px !important;
            font-family: 'Inter', sans-serif !important;
            box-shadow: 0 8px 32px rgba(21, 101, 192, .22) !important;
        }

        .swal-admin .swal2-title {
            color: #0D47A1 !important;
            font-weight: 800 !important;
            letter-spacing: -.3px;
        }

        .swal-admin .swal2-content,
        .swal-admin .swal2-html-container {
            color: #1A2B3C !important;
        }

        .swal-admin .swal2-timer-progress-bar {
            background: #1565C0 !important;
        }

        .swal-admin .swal2-footer {
            border-top-color: #BBDEFB !important;
            color: #546E7A !important;
        }

        /* Toast Admin */
        .swal-admin.swal2-toast {
        ...
        /* -- PEMILIK: Emas premium, elegan -- */
        .swal-pemilik.swal2-popup {
            border-top: 4px solid #B8860B !important;
            border-radius: 14px !important;
            font-family: 'Inter', sans-serif !important;
            box-shadow: 0 12px 40px rgba(184, 134, 11, .22) !important;
            background: #FFFDF4 !important;
        }

        .swal-pemilik .swal2-title {
            color: #7B5A00 !important;
            font-weight: 800 !important;
        }

        .swal-pemilik .swal2-content,
        .swal-pemilik .swal2-html-container {
            color: #5C4200 !important;
        }

        .swal-pemilik .swal2-timer-progress-bar {
            background: #D4A017 !important;
        }

        .swal-pemilik .swal2-footer {
            border-top-color: #F0E6C0 !important;
            color: #9B7D3A !important;
        }

        /* Toast Pemilik */
        .swal-pemilik.swal2-toast {
...
<body>
                ...
                <ul class="navbar-nav ms-auto align-items-center gap-1">
                    ...
                    @auth
                        ...
                        @if(auth()->user()->isCustomer())
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('budidaya.create') }}">
                        ...
                        @if(auth()->user()->isPemilik())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('pemilik.sales-report') }}">
                        ...
                        <li class="nav-item dropdown ms-1">
                            <a href="#" class="user-badge text-decoration-none" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <div class="user-avatar">
                                    {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                                </div>
                                <span class="user-name d-none d-md-inline">{{ Str::limit(auth()->user()->name, 14) }}</span>
                                <i class="bi bi-chevron-down text-white" style="font-size:.7rem"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li class="px-3 py-2">
                                    <div class="fw-700 text-dark" style="font-size:.85rem;font-weight:700">
                                        {{ auth()->user()->name }}
                                    </div>
                                    <div class="text-muted" style="font-size:.75rem">{{ ucfirst(auth()->user()->role) }}
                                    </div>
                                </li>
                                <li>
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="btn btn-sm ms-1" href="{{ route('register') }}"
                                style="background:rgba(255,255,255,.2);color:#fff;border:1.5px solid rgba(255,255,255,.4)">
    ...
    <footer class="footer">
        <div class="container">
            <p><i class="bi bi-fish me-1"></i> <strong>Athaya Fish Farm</strong></p>
            <p>Sistem Informasi E-Commerce Budidaya Ikan &copy; {{ date('Y') }}</p>
        </div>
    </footer>

    <!-- Floating WhatsApp Button -->
    <a href="https://wa.me/6282221299765?text=Halo,%20saya%20ingin%20bertanya%20seputar%20produk%20di%20Athaya%20Fish%20Farm"
    ...
    <script>
        ...
        // ─── ROLE THEMES ────────────────────────────────────
        const ROLE_THEME = {
            // Customer: ramah, teal/hijau, pojok kanan-bawah
            customer: {
                ...
                customClass: {
                    popup: 'swal-customer',
                    confirmButton: 'swal-btn-customer',
                },
                background: '#f0fafc',
                color: '#1A2B3C',
            },
            // Admin: tegas, merah-abu profesional, pojok kanan-atas
            admin: {
                ...
                customClass: {
                    popup: 'swal-admin',
                    confirmButton: 'swal-btn-admin',
                },
                background: '#F5F7FA',
                color: '#0D1B2A',
            },
            // Pemilik: elegan, emas/gelap, center
            pemilik: {
                ...
                customClass: {
                    popup: 'swal-pemilik',
                    confirmButton: 'swal-btn-pemilik',
                },
                background: '#FFFDF4',
                color: '#3B2800',
            },
        ...
        const ROLE_LABELS = {
            ...
            admin: { loginBtn: '⚙️ Ke Dashboard Admin', logoutMsg: 'Sesi admin telah berakhir.' },
            ...
            (() => {
                const roleConfigs = {
                    customer: {
                        ...
                        footer: '<small>Nikmati produk segar Athaya Fish Farm</small>',
                        backdrop: 'rgba(74,144,164,0.15)',
                    },
                    admin: {
                        title: '⚙️ Panel Admin',
                        confirmButtonText: '⚙️ Ke Dashboard',
                        footer: '<small>Sistem berjalan normal</small>',
                        backdrop: 'rgba(21,101,192,0.12)',
                    },
                    pemilik: {
                        title: '👑 Selamat Datang, Pemilik!',
                        confirmButtonText: '📊 Lihat Laporan',
                        footer: '<small>Pantau bisnis Anda hari ini</small>',
                        backdrop: 'rgba(184,134,11,0.12)',
                    },
        ...
        // ─── FLASH: PAYMENT SUCCESS (CUSTOMER ONLY) ──────────
        @if(session('payment_success'))
            rolePopup({
                ...
                footer: '<small>Detail pesanan akan dikirim ke email Anda</small>',
            }).then((result) => {
        ...
        @if($errors->any())
            (() => {
                const roleTitle = {
                    ...
                    admin: '⚠️ Validasi Gagal',
                    pemilik: '⚠️ Input Tidak Valid',
                ...
                rolePopup({
                    ...
                    html: '<ul style="text-align:left;margin:0;padding-left:1.2rem">' +
                        ...
                        '</ul>',
                    showConfirmButton: true,
                    confirmButtonText: '✏️ OK, Perbaiki',
                    confirmButtonColor: theme.deleteColor,
                });
            })();
        @endif
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const deleteLabels = {
                customer: { title: 'Hapus item ini?', btn: '🗑️ Ya, Hapus', cancel: 'Batal' },
                admin: { title: '⚠️ Konfirmasi Penghapusan', btn: '🗑️ Hapus Sekarang', cancel: 'Batalkan' },
                pemilik: { title: '⚠️ Tindakan Tidak Dapat Diurungkan', btn: 'Ya, Hapus Data', cancel: 'Tidak Jadi' },
