...
<style>
    ...
    .breadcrumb a:hover { color: #D4890F; text-decoration: underline; }
    ...
    .price-box-bg-icon {
        ...
        font-size: 5rem; color: rgba(245,166,35,0.05);
    }
    .price-badge {
    ...
    .price-val { font-size: 2.5rem; font-weight: 700; color: #F5A623; line-height: 1; letter-spacing: -1px; }
    .price-unit { font-size: 14px; color: #8B949E; }

    .detail-meta p { font-size: 14px; color: #374151; margin-bottom: 0.5rem; }
    .detail-meta i { color: #F5A623; width: 20px; display: inline-block; }
    ...
    .btn-add-cart:hover { background: #FFFBEB; color: #D4890F; }
    .btn-buy-now {
        background: #F5A623;
        color: #111827;
        font-weight: 600;
    ...
    .btn-buy-now:hover { background: #D4890F; transform: translateY(-1px); }
...
<div class="container detail-section">
    ...
    <div class="row g-5">
        <div class="col-md-5">
            <div class="detail-img-wrapper animate-in" style="transition-delay:60ms">
                @if($katalog->gambar)
                    <img src="{{ asset('storage/' . $katalog->gambar) }}" alt="{{ $katalog->nama_produk }}">
                @else
                    <div class="placeholder"><i class="bi bi-fish"></i></div>
                @endif
            </div>
        </div>
        ...
        <div class="col-md-7 animate-in" style="transition-delay:120ms">
            ...
            <div class="detail-category">
                <i class="bi bi-tags-fill" style="color:#F5A623"></i> {{ $katalog->jenisIkan->nama_jenis }}
            </div>
            ...
            @auth
                ...
                @else
                    {{-- Admin / Pemilik --}}
                    <div class="alert alert-info mt-4 d-flex align-items-center gap-2" style="background:#FFFBEB;border-color:#F5A623;color:#92400E;">
                        <i class="bi bi-info-circle-fill fs-5" style="color:#F5A623"></i>
                        <div>
                ...
                <div class="col-md-3">
                    <div class="product-card animate-in h-100 d-flex flex-column">
                        <div class="product-image">
                            @if($produk->gambar)
                                <img src="{{ asset('storage/' . $produk->gambar) }}" alt="{{ $produk->nama_produk }}" class="product-img-inner">
                            @else
                        ...
                        <div class="card-body d-flex flex-column" style="padding:1rem;">
                            ...
                            <a href="{{ route('katalog.show', $produk) }}" class="btn btn-sm btn-outline-primary w-100 mt-auto" style="border-color:#F5A623;color:#F5A623;">
