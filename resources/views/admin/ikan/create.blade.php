...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <h2 class="h4 font-weight-bold">Tambah Jenis Ikan Baru</h2>
        </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            <form action="{{ route('admin.ikan.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('Nama_Ikan') is-invalid @enderror" 
                           id="nama_ikan" name="Nama_Ikan" value="{{ old('Nama_Ikan') }}" 
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('Deskripsi') is-invalid @enderror" 
                              ...
                              placeholder="Masukan deskripsi jenis ikan...">{{ old('Deskripsi') }}</textarea>
                    @error('Deskripsi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('Suhu_Ideal_Min') is-invalid @enderror" 
                               id="suhu_ideal_min" name="Suhu_Ideal_Min" value="{{ old('Suhu_Ideal_Min') }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('Suhu_Ideal_Max') is-invalid @enderror" 
                               id="suhu_ideal_max" name="Suhu_Ideal_Max" value="{{ old('Suhu_Ideal_Max') }}" 
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('pH_Ideal_Min') is-invalid @enderror" 
                               id="ph_ideal_min" name="pH_Ideal_Min" value="{{ old('pH_Ideal_Min') }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('pH_Ideal_Max') is-invalid @enderror" 
                               id="ph_ideal_max" name="pH_Ideal_Max" value="{{ old('pH_Ideal_Max') }}" 
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Simpan Jenis Ikan
                    </button>
                </div>
            </form>
        </div>
