...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8">Pre-Order Saya</h1>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-start mb-4">
                ...
                <span class="px-4 py-2 rounded font-semibold
                    ...
                    @elseif($item->Status === 'ready') bg-green-100 text-green-700
            ...
            <div class="grid grid-cols-2 gap-4 mb-4 pb-4 border-b">
                ...
                <div>
                    <div class="text-sm text-gray-600">Waktu Pengambilan</div>
                    <div class="font-semibold">{{ $item->Waktu_Pengambilan->format('d M Y H:i') }}</div>
                </div>
            </div>
            ...
            <table class="w-full text-sm mb-4">
                ...
                <tbody>
                    @foreach($item->detailPreOrder as $detail)
                    <tr class="border-b">
                        <td class="py-2">{{ $detail->Nama_Item }}</td>
    ...
    <div class="bg-gray-50 rounded-lg p-16 text-center">
        <p class="text-gray-600 text-lg mb-6">Anda belum memiliki pre-order</p>
